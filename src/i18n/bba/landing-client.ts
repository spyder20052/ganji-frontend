...
/**
 * Traductions en bariba (baatɔnum) (landing-client). Clé = phrase française exacte. À valider par un locuteur natif.
 * Même découpage que l'anglais : la part de l'accueil lue par des composants clients, reprise de landing.
 */
const KEYS = [
