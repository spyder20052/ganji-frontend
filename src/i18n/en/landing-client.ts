...
/**
 * La part de l'accueil lue par des composants clients (histoire de Koffi, onglets des profils) :
 * seule envoyée au navigateur en anglais, le reste de l'accueil est traduit côté serveur.
 */
const KEYS = [
